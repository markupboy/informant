...
The Informant gets most of his strength from jQuery 1.10+, so be sure to grab those. After that, just include these JavaScript vigilantes and let them handle the rest:
